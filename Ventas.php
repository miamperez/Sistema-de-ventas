		...
		<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://www.yoga.com.mx/wp-content/uploads/2018/05/PW-YOGANEWS-DOTERRA-G.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="https://media.doterra.com/us/en/images/product/1600x720-healthy-essentials-kit.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="https://media.doterra.com/us/en/images/about-us-essential-oils.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
